...
function StoryCard({ name, src, profile }) {
  return (
    <div className="relative p-3 transition duration-200 ease-in transform cursor-pointer h-14 w-14 md:h-20 md:w-20 lg:h-56 lg:w-32 overflow-x hover:scale-105">
      <Image
